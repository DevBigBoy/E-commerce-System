...
<?php endif; ?>
    ...
    <div class="mt-6 space-y-3">
        <!-- Facebook -->
        <a href="<?php echo e(route('social.redirect', 'facebook')); ?>" class="social-btn bg-[#3b5998] hover:bg-[#3b5998]/90">
        ...
        <!-- Twitter -->
        <a href="<?php echo e(route('social.redirect', 'twitter')); ?>" class="social-btn bg-[#1da1f2] hover:bg-[#1da1f2]/90">
        ...
        <!-- GitHub -->
        <a href="<?php echo e(route('social.redirect', 'github')); ?>" class="social-btn bg-[#24292F] hover:bg-[#24292F]/90">
            <i class="fa-brands fa-github"></i>
            Sign in with GitHub
        </a>

        <!-- Google -->
        <a href="<?php echo e(route('social.redirect', 'google')); ?>" class="social-btn bg-[#4285F4] hover:bg-[#4285F4]/90">
            <i class="fa-brands fa-google"></i>
            Sign in with Google
        </a>

        <!-- Apple -->
        <a href="<?php echo e(route('social.redirect', 'apple')); ?>" class="social-btn bg-[#050708] hover:bg-[#050708]/90">
            <i class="fa-brands fa-apple"></i>
            Sign in with Apple
        </a>

        <a href="<?php echo e(route('social.redirect', 'dribbble')); ?>" class="social-btn bg-[#050708] hover:bg-[#050708]/90">
